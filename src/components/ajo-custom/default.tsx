...
<div class="w-full flex-col justify-start items-center inline-flex">
	<div class="self-stretch justify-end items-center gap-24 inline-flex">
		<div class="grow shrink basis-0 h-10 justify-center items-center gap-4 flex">
			<div class="relative w-4/5">
				<!-- input tag here with search icons -->
				...
				<input
					class="rounded-lg bg-pink-700 bg-opacity-10 text-zinc-900 text-base font-normal font-['League Spartan'] leading-normal w-full py-2 pl-10 pr-4"
					type="text"
					placeholder="Search..."
				/>
			</div>
			<div class="w-8 h-8 relative"><AllreadNotification /></div>
			<div class="w-14 self-stretch justify-center items-center gap-1 flex">
                <!-- AJOCOIN -->
                <AjoCoin/>
			</div>
			<div class="pr-1.5 rounded-2xl justify-start items-center gap-1 flex">
				<HeaderAvater />
			</div>
		</div>
	</div>
