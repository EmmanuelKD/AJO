<a href="">
	<div class="h-7 justify-center items-center gap-2 flex">
		<div class="px-0.5 py-0.5 flex-col justify-start items-start gap-2.5 inline-flex">
			<svg
		...
		<div class="text-black text-sm font-normal font-['Montserrat'] leading-tight">23.5k</div>
	</div>
</a>
