...
<div class="w-32 h-10 pr-1.5 rounded-2xl justify-start items-center gap-1 inline-flex">
    <SAvater/>
    <div class="justify-center items-center gap-1 flex">
      <div class="text-black text-base font-bold font-['League Spartan'] leading-tight">ZΞNO.sol</div>
      <div class="w-3 h-3 relative"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
        ...
        <defs>
          <clipPath id="clip0_245_11819">
            <rect width="12" height="12" fill="white" transform="translate(0.666504 0.439941)"/>
          </clipPath>
        </defs>
      </svg></div>
    </div>
